...
export default function TapisAdminPage() {
  ...
  const handleSubmit = async () => {
    try {
      ...
      setModalOpen(false);
      setForm({ _id: null, subcategory: "tapis_synthetique", name: "", price: "" }); // Reset form
      fetchData();
    } catch (err: any) {
      console.error(err);
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white p-6">
      ...
      <button
        onClick={() => { setForm({ _id: null, subcategory: "tapis_synthetique", name: "", price: "" }); setModalOpen(true); }}
