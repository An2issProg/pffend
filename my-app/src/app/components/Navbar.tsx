  ...
  if (isWorkerDashboard || isUserDashboard) {
    ...
    return (
      <motion.nav
        ...
        className="fixed top-0 left-0 right-0 z-20 bg-gray-900 border-b border-gray-800"
      >
        ...
        <div className="flex items-center gap-4">
          {isLoggedIn ? (
                  ...
                  {showDropdown && (
                    <div className="absolute right-0 mt-2 w-48 bg-gray-800 rounded-lg shadow-xl border border-gray-700 overflow-hidden z-30">
                      ...
                      <div className="py-1">
                        ...
                        <button
                          onClick={handleLogout}
                          className="w-full text-left px-4 py-2 text-sm text-red-400 hover:bg-red-500/20 transition-colors duration-200 flex items-center gap-2"
                        >
                          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
                          </svg>
            ...
            <>
              <Link
                href="/login"
                className="px-4 py-2 rounded-full text-white/80 hover:text-white transition-all duration-300"
              >
                Se connecter
              </Link>
              <Link
